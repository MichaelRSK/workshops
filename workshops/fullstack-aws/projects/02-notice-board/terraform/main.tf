...
# S3 — Frontend Hosting
# ─────────────────────────────────────────────
# TODO(step 2): aws_s3_bucket
# TODO(step 2): aws_s3_bucket_public_access_block (all block_* = false for Tier 1)
# TODO(step 2): aws_s3_bucket_website_configuration (index.html)
# TODO(step 2): aws_s3_bucket_policy (public s3:GetObject)
